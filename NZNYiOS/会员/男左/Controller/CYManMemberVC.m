...
@interface CYManMemberVC ()

@end

@implementation CYManMemberVC
...
- (void)loadData{
    ...
    // 网络请求：会员列表
    [CYNetWorkManager getRequestWithUrl:cBoyMembersListUrl params:params progress:^(NSProgress *uploadProgress) {
