...
//    chatRoomVC.view.frame = self.view.frame;
    
    self.view.userInteractionEnabled = YES;
    [self.view addSubview:chatRoomVC.view];
    [self.view bringSubviewToFront:chatRoomVC.view];
//    [self.view insertSubview:chatRoomVC.view atIndex:2];
...
// 关闭：button：点击事件：为了融云播放界面调用
- (void)closeBtnClickForPlayView{
    NSLog(@"关闭：button：点击事件：为了融云播放界面调用");
